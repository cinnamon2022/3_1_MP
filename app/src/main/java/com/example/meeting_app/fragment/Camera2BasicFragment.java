...
import com.example.meeting_app.view.AutoFitTextureView;
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.picture:
                ...
                break;
            case R.id.change:
                if(faceId == CameraCharacteristics.LENS_FACING_FRONT){
                    faceId = CameraCharacteristics.LENS_FACING_BACK;
                }else {
                    faceId = CameraCharacteristics.LENS_FACING_FRONT;
                }
                closeCamera();
                openCamera(mTextureView.getWidth(), mTextureView.getHeight());
                break;
